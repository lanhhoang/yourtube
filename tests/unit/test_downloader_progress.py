...
# --- Concrete progress hook for tests --------------------------------------


class RecordingProgress(YtdlpProgress):
    """Progress hook that records the latest values and supports cancellation."""
